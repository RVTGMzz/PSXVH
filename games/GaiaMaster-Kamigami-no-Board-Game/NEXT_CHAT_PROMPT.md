...
7. Chỉ khi transaction gắn với visible `ストーリーモード` mới đi B52R25 backtrace RAM → archive/member → patch. Runtime PASS toàn game vẫn NO.

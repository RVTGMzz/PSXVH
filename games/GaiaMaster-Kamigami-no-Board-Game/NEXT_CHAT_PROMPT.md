...
1. Dùng B52R14R1 exact SHA1 làm base oracle cho reverse tool.
2. Reverse live source của `ストーリーモード`.
3. Ưu tiên targeted/custom-packed/compression/runtime-render path.
4. Chỉ khi tìm được source có bằng chứng mới tạo patch/build để user test.
5. Sau checkpoint hữu ích kế tiếp, tạo SAFE cleanup workflow cho repo local ~20GB.

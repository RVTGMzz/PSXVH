...
def selftest():
    ...
    print('B52R29 OVERLAY FINGERPRINT RESOLVER SELFTEST PASS')
...
def main():
    ...
    csvp=outdir/'GaiaMaster_B52R29_OVERLAY_FINGERPRINTS.csv'
    ...
    rep=outdir/'GaiaMaster_B52R29_OVERLAY_FINGERPRINT_REPORT.txt'
    lines=['GAIA MASTER B52R29 OVERLAY FINGERPRINT RESOLVE','='*78,f'BIN SHA1       : {sh}',f'writer events  : {len(events)}',f'ISO files      : {len(files)}',f'fingerprint rows: {len(rows)}','']

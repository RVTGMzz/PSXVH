...
TR = ROOT / "translation"
TARGETS = TR / "BATCH33_NEW_EXACT_OFFSET_0.6.43.0.csv"
FINAL = TR / "BATCH33_FINAL_EXACT_SET_0.6.43.0.csv"

# Reuse the already-audited generic production stage. Only the exact manifests
# change; all precedence, dynamic-sink, global-map preservation and 397-key
# legacy guards remain the same implementation as Batch29/30.
...
if __name__ == "__main__":
    ...
    with staged_sources(plan):
        pass
    c = plan["counts"]
    print("BATCH33 PRODUCTION STAGING SELFTEST PASS")

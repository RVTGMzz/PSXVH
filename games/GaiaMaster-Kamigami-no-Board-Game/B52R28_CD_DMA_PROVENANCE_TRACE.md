# B52R28 - CD-DMA provenance trace
...
B52R28 is the hardware-load branch for a B52R24 linear GPU-source capture. It is useful when B52R25 finds no meaningful CPU writer or when the target RAM buffer may have been filled directly from CD-ROM DMA.
...
`GaiaMaster_B52R28_CD_DMA_TRACE.tsv`
...
No real Gaia Master B52R28 trace exists yet.
...
Do not patch a disc offset from B52R28 alone. Require agreement with B52R24 target-frame correlation and, where applicable, B52R25/B52R27 ownership evidence.

...
# PRGPACK.BDP extent = 2679
# SLPS_020.75 extent = 24
PATCHSETS = {
    # Exact retest of the old two-file JP marker, but with a new output name.
    'combo_retest': [
    ...
    # Two changed sectors, both inside PRGPACK.BDP.
    'prg_two': [
        (2679, 908648, '8351815b838082f082cd82b682df82e982e6', '8351815b838082f082cd82b682df82e982cb'),
        (2679, 0x510,  '82e282e982cb', '82e282e982e6'),
    ],

    # Two changed sectors, both inside SLPS_020.75.
    'slps_two': [
        (24, 2768,   '257382cc94d482e68149', '257382cc94d482be8149'),
        (24, 0x1130, '83548393835f815b', '83548393835f8341'),
    ],

    # A different cross-file combination.
    'combo_alt': [
        (2679, 0x510,  '82e282e982cb', '82e282e982e6'),
        (24,   0x1130, '83548393835f815b', '83548393835f8341'),
    ],
...
LABELS = {
    'combo_retest': 'COMBO_RETEST',
    'prg_two': 'PRGPACK_TWO_SECTORS',
    'slps_two': 'SLPS_TWO_SECTORS',
    'combo_alt': 'COMBO_ALT',
}
...
def regen_sector(sec):
    s = bytearray(sec)
    # MODE2 Form 1: 2048-byte user data begins at raw offset 24.
...
def build(src, mode):
    ...
    print('Building mode:', label)
    print('Copying original BIN...')
...
def main():
    if len(sys.argv) < 3:
        print('Usage: diagnostic_0.1.6.py <mode> <original BIN>')
        return 1

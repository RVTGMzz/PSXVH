...
PATCHSETS = {
    ...
    'b_only_same_sector': [
        (2679, 908668,
         '8366815b835e82aa82c882a282ed82e6',
         '8366815b835e82aa82c882a282ed82cb'),
    ],
    'a_plus_b_same_sector': [
        (2679, 908648,
         '8351815b838082f082cd82b682df82e982e6',
         '8351815b838082f082cd82b682df82e982cb'),
        (2679, 908668,
    ...
    'a_plus_c_adjacent': [
        (2679, 908648,
         ...
         '8351815b838082f082cd82b682df82e982cb'),
        (2679, 909348,
         '8366815b835e82cc838d815b8368928682e6',
         '8366815b835e82cc838d815b8368928682cb'),
    ],
}

LABELS = {
    'a_only_fresh': 'A_ONLY_FRESH',
    'b_only_same_sector': 'B_ONLY_SAME_SECTOR',
    'a_plus_b_same_sector': 'A_PLUS_B_SAME_SECTOR',
    'a_plus_c_adjacent': 'A_PLUS_C_ADJACENT',
}
...
def main():
    if len(sys.argv) < 3:
        print('Usage: diagnostic_0.1.7.py <mode> <original BIN>')
        return 1
